...
def table_data():
    xl = xlrd.open_workbook('F:/PythonLearning/PythonTraining/Training/ClosedToMatured.xlsx')
...
# # # Attached files
file_location = 'F:/PythonLearning/PythonTraining/Training/ClosedToMatured.xlsx'
